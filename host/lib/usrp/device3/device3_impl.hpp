 ...
 **********************************************************************/
static const size_t DEVICE3_RX_FC_REQUEST_FREQ         = 16;    //per flow-control window, changed from 32
static const size_t DEVICE3_TX_FC_RESPONSE_FREQ        = 2;    // changed from 8
